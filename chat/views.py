...
class ChatAPIView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        chat_session = None  # La sesión de DB (solo para autenticados)
        ...
        if is_authenticated:
            ...
            # Movemos la lógica del título AQUÍ, dentro del if is_authenticated
        ...
        if is_authenticated and chat_session:
            try:
